		...
		<main>
			<div class="container-fluid">
				...
				<ol class="breadcrumb mb-30">
					...
					<li class="breadcrumb-item"><a href="<?php echo base_url(); ?>/Books-Categories">Books Categories</a></li>
					<li class="breadcrumb-item active">Add Books Categories</li>
				</ol>
				<div class="row">
					<div class="col-lg-6 col-md-6">
					<?php $validation = \Config\Services::validation(); ?>
						<form class="cool-b4-form mt-1" action="<?php echo base_url();?>/Zrortadmin/Businesscategories/businesscategories_save" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" onSubmit="">
								...
								<div class="card-body-table">
									<div class="news-content-right pd-20">
										<div class="form-group">
											<label class="form-label">Category Tite*</label>
										...
										<button class="save-btn hover-btn" type="submit">Save Category</button>
										<a  href="<?php echo base_url(); ?>/Books-Categories" class="cancel-cst-btn">Cancel</a>
									</div> 
								</div>
							</div>
						</form>	
