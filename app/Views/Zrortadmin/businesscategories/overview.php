  ...
  font-size: 16px;
	...
	<main>
		<div class="container-fluid">
			<h2 class="mt-30 page-title">Books Categories</h2>
			...
			<div class="row justify-content-between">
				<div class="col-lg-12">
					<a href="<?php echo base_url(); ?>/Books-Categories-Add" class="add-btn hover-btn">Add New</a>
				</div>
								...
								<table id="businesscategoriesList" class="table ucp-table table-hover table-striped footable table-vcenter tbl-listing" data-filter="#filter" data-filter-text-only="true">
									<thead>
										<tr>
											...
											<th style="width: 600px;">Category Description</th>
											<th>Status</th>
											<th>Action</th>
										</tr>
									</thead>
									<tbody id="tbody">
										...
										<tr>
											...
											<td class="" style="width: 220px;"><?php echo $row['title']; ?></td>
											<td class="" style="width: 600px;"><?php echo $row['description']; ?></td>
											<td class="" ><?php if($row['is_active']==1){echo 'Active';}else{echo 'Inactive';}?></td>
											<td class="action-btns">
												<a href="<?php echo base_url(); ?>/Books-Categories-View/<?php echo $row['pk_id']?>" class="view-shop-btn" title="View"><i class="fas fa-eye"></i></a>
												<a href="<?php echo base_url(); ?>/Books-Categories-Edit/<?php echo $row['pk_id']?>" class="edit-btn" title="Edit"><i class="fas fa-edit"></i></a>
												<a href="<?php echo base_url(); ?>/Books-Categories-Delete/<?php echo $row['pk_id']?>" title="Delete" onclick="return confirm('Are you sure?')"><i class="fa fa-trash  cst-theme-text"></i></a>
											</td>
										</tr>
										<?php endforeach; ?>
									</tbody>
