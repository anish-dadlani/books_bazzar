		...
		<main>
			<div class="container-fluid">
				...
				<ol class="breadcrumb mb-30">
					...
					<li class="breadcrumb-item active">View Books Categories</li>
				</ol>
				<div class="row">
					<div class="col-lg-6 col-md-6">
						<form class="cool-b4-form mt-1" action="<?php echo base_url();?>/Zrortadmin/Businesscategories/update_businesscategories" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" onSubmit="">
							<div class="card card-static-2 mb-30">
								<div class="card-title-2">
									<h4><b>View Books Category</b></h4>
								</div>
