								...
								<div class="card-body-table">
									<div class="news-content-right pd-20">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" placeholder="Tagline" name="tags" value="<?php echo  $categories_edit[0]['tags']; ?>" required>
										</div>
										<div class="form-group">
											...
											<select id="status" name="bussiness_id" class="form-control" required>
												...
												<?php foreach($b_categories as $row) {?>
													<option <?php if($row['pk_id'] == $categories_edit[0]['business_category']) echo "selected"; ?> value="<?= $row['pk_id'] ?>"><?= $row['title']?></option>
												<?php } ?>
											</select>
										</div>
										<div class="form-group">
										...
										<button class="save-btn hover-btn" type="submit">Update Genre</button>
